...
export default {
  ...
  async mounted() {
    ...
    const apiUrl = `http://localhost:5000/getFiles?courseId=${this.courseId}&className=${this.className}&sectionName=${this.sectionName}`;
  ...
  methods: {
    async uploadFile() {
      this.error = null;
      const apiUrl = `http://localhost:5000/upload?courseId=${this.courseId}&className=${this.className}&sectionName=${this.sectionName}`;
    ...
    async removeFile(filename) {
      const apiUrl = "http://localhost:5000/removeFile";

...
class TestApp(flask_testing.TestCase):
    ...
    def setUp(self):
        ...
        # self.learner4enrolment2 = Enrolment(courseId=self.course3class1.courseId, classId=self.course3class1.classId, learnerId=self.learner4.userId, totalNumSections=10, status='ACCEPTED')
        ...
        # db.session.add(self.learner4enrolment2)
...
class TestGetLearnersInClass(TestApp):
    def test_get_learners_in_class(self):
        ...
        response = self.client.get("/enrolment/SPM G1", content_type='application/json')
...
class TestGetNumberOfLearnersInClass(TestApp):
    def test_get_number_of_learners_in_class(self):
        ...
        response = self.client.get("/enrolment/number/SPM G1", content_type='application/json')
...
class TestGetNumberOfLearnersInClassTaughtByTrainer(TestApp):
    def test_get_number_of_learners_in_class_taught_by_trainer(self):
        ...
        response = self.client.get("/enrolment/size/13/SPM", content_type='application/json')
...
class TestGetNumberOfLearnersInClassesOfACourse(TestApp):
    def test_get_number_of_learners_in_classes_of_a_course(self):
        ...
        response = self.client.get("/enrolment/size/SPM", content_type='application/json')
...
class TestGetQualifiedLearnersOfAClass(TestApp):
    def test_get_qualified_learners_of_a_class(self):
        ...
        response = self.client.get("/enrolment/qualifiedlearners/OOP G1", content_type='application/json')
...
class TestPendingEnrolments(TestApp):
    def test_pending_enrolments(self):
        ...
        response = self.client.get("/viewPendingEnrolments?classId=OOP G1", content_type='application/json')
...
class TestGetEnrolmentsInProgress(TestApp):
    def test_get_Enrolments_In_Progress(self):
        ...
        response = self.client.get("/getEnrolmentsInProgress?learnerId=4", content_type='application/json')
...
class TestGetLearnerPendingEnrolments(TestApp):
    def test_get_Learner_Pending_Enrolments(self):
        ...
        response = self.client.get("/getLearnerPendingEnrolments?learnerId=3", content_type='application/json')
...
class TestGetCompletedEnrolments(TestApp):
    def test_get_Completed_Enrolments(self):
        ...
        response = self.client.get("/getCompletedEnrolments?learnerId=5", content_type='application/json')

...
## userServices ## 
class TestSetFileCompleted(TestApp):
    def test_setFileCompleted(self):
        
        request_body = {
            "learnerId": 1,
            "fileId": "XRX-101/Class1/Section1/Hello.png"
        }
        response = self.client.post("/setFileCompleted", data=json.dumps(request_body), content_type='application/json')
